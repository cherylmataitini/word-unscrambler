...
namespace WordUnscrambler.Test.Unit
{
    ...
    public class WordMatcherTest
    {
        ...
        public void ScrambledWordMatchesGivenWordInTheList()
        {
            ...
            Assert.IsTrue(matchedWords.Count == 1); // because 'omre' should match with 'more'
            Assert.IsTrue(matchedWords[0].ScrambledWord.Equals("omre")); // remember that matchedWords is a list of structs that have the 2 properties
        ...
        public void ScrambledWordMatchesGivenWordsInTheList()
        {
            ...
            Assert.IsTrue(matchedWords.Count == 2); // there should be 2 matches
